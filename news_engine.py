...
- **최소 50자 이상** 작성, 구체적 수치·일정·기구명 포함 필수 (예: "2024년 3GPP SA2 #163 회의 참여하여 6G NTN 관련 세션 기여문서 제출")
- TTA는 **국가** 표준화 기관임. '도내', '지역', '지방' 한정 표현 절대 사용 금지 → '국내 산업계', '국내 기업', '국내 회원사' 등으로 표현
- 이미 지난 과거 시점('2024년까지', '지난해' 등) 기준의 조치사항 작성 금지 → 현재 또는 미래 시점의 실행 가능한 행동 지침만 기재
